...
public class BuildArgs
{
    ...
    [Option('y', "yagna-version", Default = "pre-rel-v0.16.0-ai-rc20", Required = false, HelpText = "Yagna version github tag")]
    public required string GolemVersion { get; set; }
    [Option('r', "runtime-version", Default = "pre-rel-v0.2.2-rc3", Required = false, HelpText = "Runtime version github tag")]
...
public class DownloadArgs
{
    ...
    public required string Target { get; set; }
    [Option('p', "version", Default = "pre-rel-v4.1.0-rc9", Required = false, HelpText = "Gamerhash module integration package version")]
