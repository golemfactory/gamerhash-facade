...
public class BuildArgs
{
    ...
    [Option('y', "yagna-version", Default = "pre-rel-v0.16.0-ai-rc8", Required = false, HelpText = "Yagna version github tag")]
    public required string GolemVersion { get; set; }
    [Option('r', "runtime-version", Default = "pre-rel-v0.2.0-rc6", Required = false, HelpText = "Runtime version github tag")]
...
public class DownloadArgs
{
    ...
    public required string Target { get; set; }
    [Option('p', "version", Default = "v2.1.0", Required = false, HelpText = "Gamerhash module integration package version")]
