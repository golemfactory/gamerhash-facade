...
public class BuildArgs
{
    ...
    [Option('y', "yagna-version", Default = "pre-rel-v0.16.0-ai-rc13", Required = false, HelpText = "Yagna version github tag")]
...
public class DownloadArgs
{
    ...
    public required string Target { get; set; }
    [Option('p', "version", Default = "v3.0.0", Required = false, HelpText = "Gamerhash module integration package version")]
