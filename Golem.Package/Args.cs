...
public class BuildArgs
{
    ...
    [Option('y', "yagna-version", Default = "pre-rel-v0.16.0-ai-rc18", Required = false, HelpText = "Yagna version github tag")]
    public required string GolemVersion { get; set; }
    [Option('r', "runtime-version", Default = "v0.2.1", Required = false, HelpText = "Runtime version github tag")]
