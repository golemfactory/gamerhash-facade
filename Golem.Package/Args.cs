...
public class BuildArgs
{
    ...
    [Option('y', "yagna-version", Default = "v0.14.0", Required = false, HelpText = "Yagna version github tag")]
...
public class DownloadArgs
{
    ...
    public required string Target { get; set; }
    [Option('p', "version", Default = "pre-rel-v0.1.0-rc10", Required = false, HelpText = "Yagna version github tag")]
